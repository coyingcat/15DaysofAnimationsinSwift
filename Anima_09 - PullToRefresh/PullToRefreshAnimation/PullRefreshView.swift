...
class PullRefreshView: UIView {
    ...
    var paths: (start: UIBezierPath, exit: UIBezierPath)!
    ...
    init(frame: CGRect, scrollView: UIScrollView) {
        ...
        let pullRefreshBackgroundImageView = UIImageView(image: UIImage(named: Images.pullRefreshViewBackground))
        ...
        let flyingSaucerImage = UIImage(named: Images.flyingSaucer)!
    ...
    func beginRefreshing() {
        ...
        hoverAnimation.timingFunction = CAMediaTimingFunction(name: CAMediaTimingFunctionName.easeInEaseOut)
        hoverAnimation.isRemovedOnCompletion = false
        hoverAnimation.fillMode = CAMediaTimingFillMode.forwards
    ...
    func endRefreshing() {
        ...
        exitPathAnimation.calculationMode = CAAnimationCalculationMode.paced
        exitPathAnimation.timingFunctions = [CAMediaTimingFunction(name: CAMediaTimingFunctionName.easeOut)]
        exitPathAnimation.beginTime = CFTimeInterval()
        
        exitPathAnimation.duration = 0.3
        exitPathAnimation.isRemovedOnCompletion = true
        exitPathAnimation.fillMode = CAMediaTimingFillMode.forwards
        ...
        sizeAlongExitPathAnimation.fillMode = CAMediaTimingFillMode.forwards
    ...
    func customPaths(frame: CGRect = CGRect(x: 4, y: 3, width: 166, height: 74)) -> ( UIBezierPath, UIBezierPath) {
        ...
        enterPath.move(to: CGPoint(x: frame.minX + 0.08146 * frame.width, y: frame.minY + startY))
        enterPath.addCurve(to: CGPoint(x: frame.minX + 0.03076 * frame.width, y: frame.minY + 0.26040 * frame.height), controlPoint1: CGPoint(x: frame.minX + 0.08146 * frame.width, y: frame.minY + startY), controlPoint2: CGPoint(x: frame.minX + 0.03814 * frame.width, y: frame.minY + 0.17848 * frame.height))
